...
###############################################################################
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'pos_receipt_invoice_send_whatsapp/static/src/customer_creation_button/customer_creation_button.js',
            'pos_receipt_invoice_send_whatsapp/static/src/customer_creation_button/customer_creation_button.xml',
            'pos_receipt_invoice_send_whatsapp/static/src/customer_creation_button/customer_creation_button.scss',
            'pos_receipt_invoice_send_whatsapp/static/src/apps/screens/product_screen/fix_discount_button/fix_discount_button.xml',
            'pos_receipt_invoice_send_whatsapp/static/src/apps/screens/product_screen/fix_discount_button/fix_discount_button.js',
            'pos_receipt_invoice_send_whatsapp/static/src/apps/store/models.js',
            'pos_receipt_invoice_send_whatsapp/static/src/apps/screens/product_screen/orderline/orderline.xml',
