...
class PartnerContactFormController(http.Controller):

    @http.route('/web/partner_contact_form', type='json', auth='user')
    def get_partner_contact_form(self):
        return self._get_partner_contact_mobile_form_view('res.partner',
                                                          'base.view_partner_form')

    def _get_partner_contact_mobile_form_view(self, model_name, view_xml_id):
        try:
