...
class Meeting(models.Model):
    ...
    def retrieve_dashboard(self):
        ...
        if 'field.visit' in self.env:
            module_data['visit'] = True
            if self._has_menu_access("field_visit.menu_field_visit"):
                visits = self.env['field.visit']
                result['visit_count'] = visits.search_count([
                    ('user_id', '=', user.id)
                ])
                menu_access['visit'] = True
            else:
                menu_access['visit'] = False
        else:
            module_data['visit'] = False
            menu_access['visit'] = False
